...
using si730ebu202023992.Infraestructure.Maintenance;
...
builder.Services.AddScoped<IMActivitiesInfraestructure, MActivitiesDBInfraestructure>();
builder.Services.AddScoped<IMActivitiesDomain, MActivitiesDomain>();
...
builder.Services.AddAutoMapper(
    ...
    typeof(MActivitiesToResponse),
    typeof(RequestToMActivities)
);
